...
import { dynamicLeaflet } from "./leaflet-dynamic"

const LeafletMapContainer = lazy(dynamicLeaflet("MapContainer"));
const LeafletTileLayer = lazy(dynamicLeaflet("TileLayer"));
const LeafletMarker = lazy(dynamicLeaflet("Marker"));
const LeafletPopup = lazy(dynamicLeaflet("Popup"));
const LeafletTooltip = lazy(dynamicLeaflet("Tooltip"));
const LeafletCircle = lazy(dynamicLeaflet("Circle"));
const LeafletCircleMarker = lazy(dynamicLeaflet("CircleMarker"));
const LeafletPolyline = lazy(dynamicLeaflet("Polyline"));
const LeafletPolygon = lazy(dynamicLeaflet("Polygon"));
const LeafletRectangle = lazy(dynamicLeaflet("Rectangle"));
const LeafletLayerGroup = lazy(dynamicLeaflet("LayerGroup"));
const LeafletFeatureGroup = lazy(dynamicLeaflet("FeatureGroup"));
...
function useLeaflet() {
    ...
    const [LeafletDraw, setLeafletDraw] = useState<any>(null)
    ...
    useEffect(() => {
        ...
        async function loadLeaflet() {
            ...
            if (!LeafletDraw) {
                ...
                if (mounted) setLeafletDraw(draw);
            }
        }
